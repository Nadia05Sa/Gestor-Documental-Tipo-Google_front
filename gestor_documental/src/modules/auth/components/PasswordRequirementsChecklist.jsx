...
const REQUIREMENT_CONFIG = [
  { key: 'minLength', label: 'Longitud mínima de 8 caracteres.' },
  { key: 'hasUppercase', label: 'Debe incluir al menos una letra mayúscula.' },
  { key: 'hasSpecialCharacter', label: 'Debe incluir al menos un signo especial.' },
];
