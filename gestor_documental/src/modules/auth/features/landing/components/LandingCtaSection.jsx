...
import { LANDING_CTA } from '../../../constants/landingContent';
import { CTA_BANNER_GRADIENT, MANROPE_STYLE } from '../../../constants/theme';

export const LandingCtaSection = ({ onRegister, isBusy, isRegisterLoading }) => (
