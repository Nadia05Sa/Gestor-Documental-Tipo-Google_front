...
import { MANROPE_STYLE, primaryAuthButtonStyle } from '@shared/utils/authTheme';
import type { RegisterSuccessProps } from '../types/register.types';

export const RegisterSuccess = ({ email, onGoToLogin }: RegisterSuccessProps) => (
